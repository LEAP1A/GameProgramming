...
void Utility::draw_background(ShaderProgram *program, glm::mat4 &object_g_model_matrix,GLuint& object_texture_id) {
    program->set_model_matrix(object_g_model_matrix);
    
    float vertices[] = {
        -5.0f, -375.0f, 5.0f, -375.0f, 5.0f, 375.0f,
        -5.0f, -375.0f, 5.0f, 375.0f, -5.0f, 375.0f
    };

    float texture_coordinates[] = {
        0.0,  100.0f, 1.0, 100.0f, 1.0, 0.0,
        0.0,  100.0f, 1.0, 0.0,  0.0, 0.0
    };
